...
import { contentType } from "../src/infra/http/route-fs.ts";
...
async function renderEmbeddedWebAssetsModule(filePaths: readonly string[]) {
  ...
  const lines = [
    ...
    "} as const;",
    "",
    "export const embeddedWebAssets: Record<string, EmbeddedWebAsset> = embeddedWebAssetsRecord;",
    "",
  ];
