...
| 4   | **partial** — leaf deps filled on missing/rss-feed/catalog scan+write/enrollment; full Default trees still blocked by client/progress/config nests |
| 5   | **done** — PureDbLeaves once at lifecycle; media/ops take leaves arg; anime* → media* wiring names                                                 |
| 6   | **partial** — public surface download-repository; catalog-read + row-codec marked internal                                                         |
