...
export class TokenHasherError extends Schema.TaggedErrorClass<TokenHasherError>()(
  "TokenHasherError",
  {
...
export class TokenHasher extends Context.Service<TokenHasher>()("@bakarr/security/TokenHasher", {
  make: Effect.succeed({ hashToken }),
}) {
  static readonly layer = Layer.effect(TokenHasher, TokenHasher.make);
}
