...
export class BackgroundWorkerController extends Context.Service<BackgroundWorkerController>()(
  "@bakarr/api/BackgroundWorkerController",
  { make: makeBackgroundWorkerControllerLive() },
) {
  static readonly layer = Layer.effect(BackgroundWorkerController, BackgroundWorkerController.make);
}
