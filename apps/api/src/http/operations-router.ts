    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          return yield* Effect.flatMap(
            LibraryService,
            (service) => service.getWantedMissing(query.limit ?? 50),
          );
        }),
      ),
      jsonResponse,
    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          const now = yield* Effect.flatMap(
            ClockService,
  ...
  HttpRouter.get(
    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.flatMap(
          LibraryService,
          (service) => service.getUnmappedFolders(),
        ),
      ),
      jsonResponse,
    ),
      ...
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          const body = text.trim().length === 0
            ...
            : yield* Schema.decode(Schema.parseJson(SearchMissingBodySchema))(
              text,
            ).pipe(
              Effect.mapError(() =>
          ...
          yield* Effect.flatMap(
            DownloadService,
            (service) => service.triggerSearchMissing(body.anime_id),
          );
        }),
      ),
      successResponse,
    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          yield* Effect.flatMap(
            DownloadService,
            (service) => service.pauseDownload(params.id),
          );
        }),
      ),
      successResponse,
    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          yield* Effect.flatMap(
            DownloadService,
            (service) => service.resumeDownload(params.id),
          );
        }),
      ),
      successResponse,
    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          yield* Effect.flatMap(
            DownloadService,
            (service) => service.retryDownload(params.id),
          );
        }),
      ),
      successResponse,
    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          yield* Effect.flatMap(
            DownloadService,
            (service) => service.reconcileDownload(params.id),
          );
        }),
      ),
      successResponse,
    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          return yield* Effect.flatMap(
            RssService,
            (service) => service.addRssFeed({ ...body }),
          );
        }),
      ),
      jsonResponse,
    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          yield* Effect.flatMap(
            RssService,
            (service) => service.deleteRssFeed(params.id),
          );
        }),
      ),
      successResponse,
    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          yield* Effect.flatMap(
            LibraryService,
            (service) => service.controlUnmappedFolder({ ...body }),
          );
        }),
      ),
      successResponse,
    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          yield* Effect.flatMap(
            LibraryService,
            (service) => service.bulkControlUnmappedFolders({ ...body }),
          );
        }),
      ),
      successResponse,
    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          yield* Effect.flatMap(
            LibraryService,
            (service) => service.importUnmappedFolder({ ...body }),
          );
        }),
      ),
      successResponse,
    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          return yield* Effect.flatMap(
            LibraryService,
            (service) => service.scanImportPath(body.path, body.anime_id),
          );
        }),
      ),
      jsonResponse,
    ...
    routeResponse(
      Effect.zipRight(
        ...
        Effect.gen(function* () {
          ...
          return yield* Effect.flatMap(
            LibraryService,
            (service) => service.importFiles([...body.files]),
          );
        }),
      ),
      jsonResponse,
