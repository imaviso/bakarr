...
it.scoped("JikanClient maps full detail with recommendations", () =>
  Effect.gen(function* () {
    ...
    if (Option.isSome(result)) {
      ...
      assert.deepStrictEqual(result.value.unitCount, 64);
      ...
      assert.deepStrictEqual(
        ...
        "https://cdn.example/media/5114.jpg",
      );
      assert.deepStrictEqual(
        result.value.images.webp?.largeImageUrl,
        "https://cdn.example/media/5114.webp",
      );
...
it.scoped("JikanClient decodes seasonal media response and applies limit", () =>
  Effect.gen(function* () {
    ...
    assert.deepStrictEqual(first.coverImage, "https://cdn.example/media/50001.jpg");
    ...
    assert.deepStrictEqual(second.unitCount, undefined);
  }),
);
...
function buildDetailPayload(malId: number) {
  return {
    data: {
      ...
      images: {
        jpg: {
          image_url: "https://cdn.example/media/5114.jpg",
          large_image_url: "https://cdn.example/media/5114-lg.jpg",
          small_image_url: "https://cdn.example/media/5114-sm.jpg",
        },
        webp: {
          image_url: "https://cdn.example/media/5114.webp",
          large_image_url: "https://cdn.example/media/5114.webp",
          small_image_url: "https://cdn.example/media/5114-sm.webp",
        },
      },
      licensors: [
        {
    ...
    data: [
      {
        ...
        images: {
          jpg: {
            image_url: "https://cdn.example/media/50001.jpg",
            large_image_url: "https://cdn.example/media/50001-lg.jpg",
            small_image_url: "https://cdn.example/media/50001-sm.jpg",
          },
          webp: {
            image_url: "https://cdn.example/media/50001.webp",
          },
        },
        mal_id: 50001,
        score: 8.5,
      ...
      },
      {
        ...
        airing: true,
        genres: [{ mal_id: 10, name: "Fantasy", type: "media" }],
        images: {},
        mal_id: 50002,
        season: "spring",
        status: "Currently Airing",
