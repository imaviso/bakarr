  ...
  withSqliteTestDbEffect({
    run: (db, _databaseFile) =>
      Effect.gen(function* () {
        ...
        yield* tryDatabase("Failed to seed media for presentation test", () =>
        ...
        yield* tryDatabase("Failed to seed mediaUnits for presentation test", () =>
        ...
        const [row] = yield* tryDatabase("Failed to insert download for presentation test", () =>
          db
