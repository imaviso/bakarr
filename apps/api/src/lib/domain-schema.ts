...
export const DownloadIdSchema = PositiveIntSchema.pipe(
...
export const EpisodeNumberSchema = PositiveIntSchema.pipe(
...
export const ReleaseProfileIdSchema = PositiveIntSchema.pipe(
  Schema.brand("ReleaseProfileId"),
);
