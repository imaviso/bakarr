...
describe("notification preferences", () => {
  it.each([
    ...
    [{ type: "RefreshStarted", payload: { anime_id: 1, title: "Show" } }, "refresh"],
    [
      { type: "SearchMissingFinished", payload: { anime_id: 1, count: 2, title: "Show" } },
      "search_missing",
    ],
    [{ type: "ScanFolderStarted", payload: { anime_id: 1, title: "Show" } }, "scan_folder"],
    [{ type: "RenameFinished", payload: { anime_id: 1, count: 2, title: "Show" } }, "rename"],
