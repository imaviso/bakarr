import { brandMediaId, type Media } from "@bakarr/shared";
...
const FIXTURE: Media[] = [
  createMedia({ id: 1, romaji: "ONE PIECE", english: "One Piece", monitored: true }),
  createMedia({ id: 2, romaji: "Naruto", english: "Naruto", monitored: true }),
  createMedia({ id: 3, romaji: "Hunter x Hunter", english: "Hunter x Hunter", monitored: false }),
];
