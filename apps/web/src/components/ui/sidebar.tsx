...
export type { CSSVars } from "@/components/ui/sidebar/constants";
...
function Sidebar({
  ...
  dir,
  ...props
}: Omit<React.ComponentProps<"div">, "className" | "style" | "ref" | "key" | "slot"> & {
  side?: "left" | "right";
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 transition-[transform,opacity] ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:start-1/2 after:w-0.5 hover:after:bg-sidebar-border sm:flex ltr:-translate-x-1/2 rtl:-translate-x-1/2",
...
function SidebarMenuSkeleton({
  ...
  const skeletonStyle: CSSVars = { "--skeleton-width": width };
