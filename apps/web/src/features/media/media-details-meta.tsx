  ...
  return (
    <>
      <div className="flex flex-wrap items-center gap-x-6 gap-y-3 border-b border-border pb-4">
        <StatItem label="Total" value={props.totalUnits} />
        <StatItem label="Downloaded" value={props.downloadedUnits} tone="success" />
        <StatItem label="Missing" value={props.missingUnits} tone="warning" />
